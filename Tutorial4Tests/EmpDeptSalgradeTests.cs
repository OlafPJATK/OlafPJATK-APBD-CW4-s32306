...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldReturnAllSalesmen()
    {
        ...
        List<Emp> result = Database.GetEmps().Where(e => e.Job == "SALESMAN").ToList(); 
    ...
    public void ShouldMatchEmployeeToSalaryGrade()
    {
        ...
        var result = emps.Join(grades,e=>true,g=>true,(e,g) => new {e.EName,g.Grade,e.Sal,g.Losal,g.Hisal})
    ...
    public void ShouldReturnEmployeesEarningMoreThanDeptAverage()
    {
        var emps = Database.GetEmps();
         ...
         var result = emps.Where(e => e.Sal > emps.Where(ee => ee.DeptNo == e.DeptNo).Average(ee => ee.Sal)).Select(e => e.EName).ToList(); 
